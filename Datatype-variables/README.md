...
### 2. The 7 Primitives
JavaScript has 7 primitive data types: `String`, `Number`, `Boolean`, `Null`, `Undefined`, `BigInt`, and `Symbol`.Contains only one value
Non-Primitive: Object , Array , Function . which contain more the one value
